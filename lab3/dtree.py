...
def main():
	...
	print 'decision tree classifier being trained'
	...
	print "dtree trained in "+str(end-start)+"s"
	start = time.clock()
	acc = dtree.predict(test_data)
	end = time.clock()

	print "\ttested in "+str(end-start)+"s"		
	print "\taccuracy= " + str(dtree.score(test_data, test_labels))
